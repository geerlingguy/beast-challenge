--- To use:
---   wrk "http://127.0.0.1:5005/" -s wrk_press.lua --latency -t 2 -c 2 -d 5s
---
...
--- Requests submitting press option 0
request1 = function()
    headers = {}
    headers["Content-Type"] = "application/json"
    body = '{"room_id": ' .. rooms[math.random(#rooms)] .. ',"value": 0}'
    return wrk.format("POST", "/press", headers, body)
end

--- Requests submitting press option 1
request2 = function()
    headers = {}
    headers["Content-Type"] = "application/json"
...
--- Requests submitting press option 2
request3 = function()
    headers = {}
    headers["Content-Type"] = "application/json"
